...
test("Router settings use the trusted backend and display recorded inference usage", async () => {
  ...
  assert.match(rendererPatch, /Chat reasoning/);
  assert.match(rendererPatch, /Computer reasoning/);
  ...
  assert.match(rendererPatch, /openai\/gpt-4\.1/);
  assert.match(rendererPatch, /Chat model/);
  assert.match(rendererPatch, /Computer model/);
  assert.match(rendererPatch, /Same as chat/);
  ...
  assert.match(preload, /setInferenceRouter: \(provider: string, extras\?: \{ readonly model\?: string; readonly computerModel\?: string \| null; readonly reasoningEffort\?: string; readonly computerReasoningEffort\?: string \}\)/);
  ...
  assert.match(mainEdge, /currentId: \[model, computerModel\]/);
  ...
  assert.match(providers, /configuredOpenRouterReasoningEffort\(computer\)/);
  ...
  assert.match(providers, /routedToolsIncludeComputer\(definitions \?\? \[\]\)/);
  ...
  assert.match(coordinator, /setTimeout\(resolve, options\.composingDelayMs \?\? 1_200\)/);

...
test("Router settings use the trusted backend and display recorded inference usage", async () => {
  ...
  assert.match(rendererPatch, /providers=docker\?RRouterProviders\.filter/);
  assert.match(rendererPatch, /docker\?null:a\.jsx\(re,\{title:"Computer"/);
  ...
  assert.match(rendererPatch, /local container on this Mac/);

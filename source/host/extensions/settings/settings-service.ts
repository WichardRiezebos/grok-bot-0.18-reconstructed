...
import { normalizeOpenRouterModelId, normalizeOpenRouterReasoningEffort } from "../../../shared/openrouter-models.js";
...
export class SettingsService {
  ...
  setHostSettings(update: HostSettingsUpdate) {
    ...
    const openRouterModel = normalizeOpenRouterModelId(update.openRouterModel);
    if (openRouterModel !== undefined) this.store.setOpenRouterModel(openRouterModel);
    if (update.openRouterComputerModel === null) this.store.setOpenRouterComputerModel(undefined);
    else {
    ...
    if (openRouterComputerReasoningEffort !== undefined) this.store.setOpenRouterComputerReasoningEffort(openRouterComputerReasoningEffort);
